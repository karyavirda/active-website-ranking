<x-app-layout>
    <div class="py-12 max-w-xl mx-auto">
        ...
        <div class="bg-white p-6 shadow sm:rounded-lg">
            ...
            <div class="bg-blue-50 p-4 rounded mb-4 text-sm text-blue-700 border border-blue-200">
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <ul class="list-disc ml-4 text-xs">
                            <li>Tabel: <code>data_images</code></li>
            ...
            <form action="{{ route('data-images.import-process') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('data-images.index') }}" class="px-4 py-2 bg-gray-200 rounded">Batal</a>
                </div>
            </form>
        </div>
    </div>
