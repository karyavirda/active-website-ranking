<x-app-layout>
    <div class="py-12 max-w-2xl mx-auto">
        ...
        <div class="bg-white p-6 shadow sm:rounded-lg">
            ...
            <form action="{{ route('data-pages.update', $pages->id) }}" method="POST">
                @csrf @method('PUT')
                <input type="number" name="id" value="{{ $pages->id }}" class="w-full mb-2 border rounded p-2" required>

                <input type="text" name="subdomain" value="{{ $pages->subdomain }}"
