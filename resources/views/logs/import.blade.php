<x-app-layout>
    <div class="py-12 max-w-xl mx-auto">
        ...
        <div class="bg-white p-6 shadow sm:rounded-lg">
                ...
                <div class="grid grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <ul class="list-disc ml-4 text-xs">
                            ...
                            <li>Kolom C: Nama Admin</li>
                            <li>Kolom D: Aktivitas</li>
                            <li>Kolom E: Tanggal Aktivitas (Y-m-d H:i:s)</li>
                        </ul>
                    </div>
                    <div>
                        <p class="font-bold">Format SQL:</p>
                        <ul class="list-disc ml-4 text-xs">
                            <li>Tabel: <code>data_logs</code></li>
            ...
            <form action="{{ route('data-logs.import-process') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('data-logs.index') }}" class="px-4 py-2 bg-gray-200 rounded">Batal</a>
                </div>
            </form>
        </div>
    </div>
