    ...
    <div class="py-12 max-w-2xl mx-auto">
        ...
        <div class="bg-white p-6 shadow sm:rounded-lg">
            ...
            <form action="{{ route('data-parts.update', $parts->id) }}" method="POST">
                ...
                <input type="text" name="judul" value="{{ $parts->judul }}" class="w-full mb-2 border rounded p-2"
                    required>

                <input type="text" name="tipe" value="{{ $parts->tipe }}" class="w-full mb-2 border rounded p-2"
                    required>

                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Dibuat</label>
                    <input type="datetime-local" name="created_at" value="{{ $parts->created_at }}"
