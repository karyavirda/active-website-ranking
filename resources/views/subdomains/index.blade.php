<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800">Data Subdomains</h2>
            <div class="flex gap-2">
                <a href="{{ route('subdomains.create') }}"
                    class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Add Data</a>
                <a href="{{ route('subdomains.import') }}"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg border border-gray-200">
                <table class="w-full text-sm text-left text-gray-600" id="subdomains-table">
...
<script>
    $(document).ready(function () {
        $('#subdomains-table').DataTable({
            ...
            // Tambahkan ini untuk menomori baris
            ...
            columns: [
                { data: null, name: 'id', className: 'px-6 py-4' }, // data: null agar tidak mengambil ID database
                { data: 'subdomain', name: 'subdomain', className: 'px-6 py-4' },
                { data: 'paket', name: 'paket', className: 'px-6 py-4' },
